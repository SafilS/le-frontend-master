  ...
  <section className="min-h-screen bg-gradient-to-br from-cyan-50 via-teal-50 to-blue-50 py-20">
    <div className="mt-10 container mx-auto px-6">
      ...
      >
        ...
        >
          <span className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black bg-gradient-to-r from-cyan-600 via-teal-500 to-blue-500 bg-clip-text text-transparent tracking-wider relative">
            BATH
          </span>
