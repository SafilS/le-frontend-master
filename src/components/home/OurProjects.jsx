...
const categoryRouteMap = {
  office: '/office',
  commercial: '/gallery', // assuming commercial → gallery
  creative: '/gallery',   // assuming creative → gallery
  residential: '/bedroom', // or '/living-room' based on your structure
};
  ...
  const MobileCarousel = () => (
    <div className="relative w-full overflow-hidden">
      ...
      {/* Navigation Arrows */}
      <button
        className="absolute left-4 top-1/2 transform -translate-y-1/2 w-10 h-10 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/20 transition-colors border border-white/20"
      ...
      <button
        className="absolute right-4 top-1/2 transform -translate-y-1/2 w-10 h-10 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/20 transition-colors border border-white/20"
    ...
    <section className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            <span className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black bg-gradient-to-r from-red-600 via-orange-500 to-yellow-500 bg-clip-text text-transparent tracking-wider relative">
              OUR
            </span>
                ...
                <div className="p-4 sm:p-6 md:p-8">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <button
                      ...
                      onClick={() => {
                        const route = categoryRouteMap[selectedProject.category] || '/gallery'; // fallback route
                        navigate(route);
                        closeProjectDetails();
                      }}
                    >
