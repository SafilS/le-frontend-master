...
export default function Chatbot() {
  ...
  return (
    <div>
      ...
      {chatOpen && (
        <div className="fixed inset-0 md:bottom-0 md:right-0 md:top-0 md:left-auto w-full h-full sm:h-[95%] sm:bottom-0 sm:right-0 sm:left-0 sm:rounded-t-2xl md:w-[440px] lg:w-[460px] bg-white md:bg-white/95 md:backdrop-blur-xl flex flex-col z-50 md:border-l md:border-amber-200/50 md:shadow-2xl overflow-hidden">
